...
class LaminaCalculadora extends JPanel{
	public LaminaCalculadora(){
		...
		LaminaInferior laminaInferior = new LaminaInferior();
	...
	//clase para agregar los números pulsados al display
	private class MuestraNumero implements ActionListener{
		public void actionPerformed(ActionEvent evento) {
			
			//devuelve el string asociado con esta acción
			//en este caso, que me devuelva el número ingresado
			String entrada = evento.getActionCommand();
			//pregunto si reción arranca el programa
			if(ceroInicial){
				pantalla.setText("");
				ceroInicial = false;
			}
			//le pone ese número a la pantalla
	...
	private class Operaciones implements ActionListener{
		...
		//método motor de la calculadora
...
class LaminaInferior extends JPanel{
	public LaminaInferior(){
		...
		JButton miEtiqueta = new JButton("PokéCalculadora", new ImageIcon(rutaImagen));
		add(miEtiqueta);
	}
}