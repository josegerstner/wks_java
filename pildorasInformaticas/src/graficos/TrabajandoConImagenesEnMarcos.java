...
public class TrabajandoConImagenesEnMarcos {
...
class MarcoConImagenes extends JFrame{
	public MarcoConImagenes(){
		...
		add(miLamina);
		try{
			imagen = ImageIO.read(new File("src/graficos/imagenes/pikawaii.png"));//la clase ImageIO lanza una excepci�n si no la encuentra
...
class LaminaConImagenes extends JPanel{
	public void paintComponent(Graphics g){
		...
		File miImagen = new File("src/graficos/imagenes/pikachu_mini.jpg");
		try{
